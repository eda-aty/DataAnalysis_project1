...
Bu projeyi hem İngilizce hem Türkçe açıklamalarla anlatmaya çalışacağım.
...
![Screen Shot 2025-01-27 at 18 33 56](https://github.com/user-attachments/assets/e047f628-363b-47d5-b124-7690f529542b)
...
**Stage 1:**
Let's combine the sales table and the menu table with the JOIN 
Let's count how many of each product they bought with count function
Since we are connecting the tables according to product_id, we need to specify which table we are calling this product id from; we can specify this by writing s.product_id.
Since we are using the aggregate function, we can run the command by grouping according to 1,2.
...
**Sonuç: **
Müşteri A'nın en çok sipariş ettiği ürün ramendir.
Müşteri B, köri, suşi ve ramen'i eşit olarak sipariş etti. 
Müşteri C'nin en sevdiği ürün ramendir.
